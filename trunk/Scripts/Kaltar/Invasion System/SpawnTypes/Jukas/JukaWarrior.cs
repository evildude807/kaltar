...
namespace Scripts.Invasion_System
{
    ...
    public class InvasionJukaWarrior : InvasionSpawn
	{
		[Constructable]
        public InvasionJukaWarrior(InvasionController c)
            : base(c, InvasionSpawnType.Jukas, AIType.AI_Melee, FightMode.Closest, new double[] { 10, 1, 0.2, 0.4 })
		{
			Name = "a juka warrior";
			Body = 764;
		...
		public InvasionJukaWarrior( Serial serial ) : base( serial )
		{
		}
