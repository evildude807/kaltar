...
namespace Scripts.Invasion_System
{
    ...
    public class InvasionPoisonElemental : InvasionSpawn
	{
		[Constructable]
        public InvasionPoisonElemental(InvasionController c)
		...
		public InvasionPoisonElemental( Serial serial ) : base( serial )
		{
		}
