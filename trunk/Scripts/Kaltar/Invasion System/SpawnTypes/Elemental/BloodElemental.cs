...
namespace Scripts.Invasion_System
{
    ...
    public class InvasionBloodElemental : InvasionSpawn
	{
		[Constructable]
        public InvasionBloodElemental(InvasionController c)
		...
		public InvasionBloodElemental( Serial serial ) : base( serial )
		{
		}
