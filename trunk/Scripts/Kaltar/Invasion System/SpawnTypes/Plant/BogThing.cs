...
namespace Scripts.Invasion_System
{
    ...
    public class InvasionBogThing : InvasionSpawn
	{
		[Constructable]
        public InvasionBogThing(InvasionController c)
            : base(c, InvasionSpawnType.Plant, AIType.AI_Melee, FightMode.Closest, new double[] { 10, 1, 0.6, 1.2 })
		{
			Name = "a bog thing";
			Body = 780;
		...
		public InvasionBogThing( Serial serial ) : base( serial )
		{
		}
