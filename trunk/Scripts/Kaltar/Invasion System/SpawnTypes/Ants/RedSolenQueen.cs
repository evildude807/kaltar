...
namespace Scripts.Invasion_System
{
    ...
    public class InvasionRedSolenQueen : InvasionSpawn
	{
		[Constructable]
        public InvasionRedSolenQueen(InvasionController c)
		...
		public InvasionRedSolenQueen( Serial serial ) : base( serial )
		{
		}
