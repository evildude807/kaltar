...
namespace Scripts.Invasion_System
{
    ...
    public class InvasionBlackSolenQueen : InvasionSpawn
	{

		[Constructable]
        public InvasionBlackSolenQueen(InvasionController c)
		...
		public InvasionBlackSolenQueen( Serial serial ) : base( serial )
		{
		}
