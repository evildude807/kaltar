...
namespace Scripts.Invasion_System
{
	...
	public class InvasionBlackSolenInfiltratorQueen : InvasionSpawn
	{
		[Constructable]
        public InvasionBlackSolenInfiltratorQueen(InvasionController c)
		...
		public InvasionBlackSolenInfiltratorQueen( Serial serial ) : base( serial )
		{
		}
