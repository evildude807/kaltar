...
namespace Scripts.Invasion_System
{
    ...
    public class InvasionRedSolenWorker : InvasionSpawn
	{
		[Constructable]
        public InvasionRedSolenWorker(InvasionController c)
		...
		public InvasionRedSolenWorker( Serial serial ) : base( serial )
		{
		}
