...
namespace Scripts.Invasion_System
{
    ...
    public class InvasionRedSolenInfiltratorWarrior : InvasionSpawn
	{
		[Constructable]
        public InvasionRedSolenInfiltratorWarrior(InvasionController c)
		...
		public InvasionRedSolenInfiltratorWarrior( Serial serial ) : base( serial )
		{
		}
