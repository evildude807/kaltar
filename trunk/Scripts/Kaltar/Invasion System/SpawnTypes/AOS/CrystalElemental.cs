...
namespace Scripts.Invasion_System
{
    ...
    public class InvasionCrystalElemental : InvasionSpawn
	{
		...
		[Constructable]
        public InvasionCrystalElemental(InvasionController c)
		...
		public InvasionCrystalElemental( Serial serial ) : base( serial )
		{
		}
