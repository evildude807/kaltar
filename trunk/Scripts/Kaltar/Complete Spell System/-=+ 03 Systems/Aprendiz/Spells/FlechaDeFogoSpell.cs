...
namespace Server.ACC.CSS.Systems.Aprendiz {
	...
	public class FlechaDeFogoSpell : AprendizSpell {
		...
		public FlechaDeFogoSpell( Mobile caster, Item scroll ) : base( caster, scroll, m_Info ) {
		}
		...
		private class InternalTarget : Target {
			private FlechaDeFogoSpell m_Owner;

			public InternalTarget( FlechaDeFogoSpell owner ) : base(12, false, TargetFlags.Harmful ) {
				m_Owner = owner;
			}
