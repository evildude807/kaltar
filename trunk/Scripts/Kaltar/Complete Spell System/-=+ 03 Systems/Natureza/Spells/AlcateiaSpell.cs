...
namespace Server.ACC.CSS.Systems.Natureza {
    ...
    public class AlcateiaSpell : NaturezaSpell {
        ...
        public AlcateiaSpell(Mobile caster, Item scroll)
        ...
        public override void OnCast()
        {
            if (CheckSequence())
            {
                ...
                for(int i =0; i < quantidade; i++) {
                    TimberWolf lobo = new TimberWolf();
                    SpellHelper.Summon(lobo, Caster, 0x215, duracao, false, false);
                }
            }
