...
{
	public class NecroPoisonFieldSpell : UndeadSpell
	{
		...
		public NecroPoisonFieldSpell( Mobile caster, Item scroll ) : base( caster, scroll, m_Info )
		{
		}
		...
		{
			private NecroPoisonFieldSpell m_Owner;
			
			public InternalTarget( NecroPoisonFieldSpell owner ) : base( 12, true, TargetFlags.None )
			{
				m_Owner = owner;
			}
