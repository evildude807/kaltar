...
{
	public class ProtecaoFrioSpell : SeminaristaSpell {
		...
		public ProtecaoFrioSpell( Mobile caster, Item scroll ) : base( caster, scroll, m_Info ) {
		}
		...
		private class InternalTarget : Target {
			private ProtecaoFrioSpell m_Owner;

			public InternalTarget( ProtecaoFrioSpell owner ) : base( 1, false, TargetFlags.Beneficial ) {
				m_Owner = owner;
			}
