...
{
	public class BetRune : Item
	{
		[Constructable]
		public BetRune() : base( 0x1F14 )
		{
			Weight = 0.2;  // ?
			Name = "Bet Rune";
			Hue = 998;
		...
		{
			private BetRune m_BetRune;

			public InternalTarget( BetRune runeaug ) : base( 1, false, TargetFlags.None )
			{
				m_BetRune = runeaug;
			}
				...
				{ 
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							...
							Weapon.WeaponAttributes.HitMagicArrow += augmentper; from.SendMessage( "The Bet Rune enhances your weapon." );
		...
		public BetRune( Serial serial ) : base( serial )
		{
		}
