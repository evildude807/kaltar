...
{
	public class ArmaRune : Item
	{
		[Constructable]
		public ArmaRune() : base( 0x1F14 )
		{
			Weight = 0.2;  // ?
			Name = "Arma Rune";
			Hue = 999;
		...
		{
			private ArmaRune m_ArmaRune;

			public InternalTarget( ArmaRune runeaug ) : base( 1, false, TargetFlags.None )
			{
				m_ArmaRune = runeaug;
			}
				...
				{ 
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							...
							Weapon.WeaponAttributes.UseBestSkill += augmentper; from.SendMessage( "The Arma Rune enhances your weapon." );
		...
		public ArmaRune( Serial serial ) : base( serial )
		{
		}
