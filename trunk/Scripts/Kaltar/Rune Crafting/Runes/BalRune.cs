...
{
	public class BalRune : Item
	{
		[Constructable]
		public BalRune() : base( 0x1F14 )
		{
			Weight = 0.2;  // ?
			Name = "Bal Rune";
			Hue = 999;
		...
		{
			private BalRune m_BalRune;

			public InternalTarget( BalRune runeaug ) : base( 1, false, TargetFlags.None )
			{
				m_BalRune = runeaug;
			}
				...
				{ 
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							...
							Weapon.WeaponAttributes.HitLeechStam += augmentper; from.SendMessage( "The Bal Rune enhances your weapon." );
		...
		public BalRune( Serial serial ) : base( serial )
		{
		}
