...
{
	public class QuasRune : Item
	{
		[Constructable]
		public QuasRune() : base( 0x1F14 )
		{
			Weight = 0.2;  // ?
			Name = "Quas Rune";
			Hue = 998;
		...
		{
			private QuasRune m_QuasRune;

			public InternalTarget( QuasRune runeaug ) : base( 1, false, TargetFlags.None )
			{
				m_QuasRune = runeaug;
			}
				...
				{ 
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							...
							Weapon.WeaponAttributes.HitLeechMana += augmentper; from.SendMessage( "The Quas Rune enhances your weapon." );
		...
		public QuasRune( Serial serial ) : base( serial )
		{
		}
