...
{
	public class GravRune : Item
	{
		[Constructable]
		public GravRune() : base( 0x1F14 )
		{
			Weight = 0.2;  // ?
			Name = "Grav Rune";
			Hue = 1001;
		...
		{
			private GravRune m_GravRune;

			public InternalTarget( GravRune runeaug ) : base( 1, false, TargetFlags.None )
			{
				m_GravRune = runeaug;
			}
				...
				{ 
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							...
							Weapon.WeaponAttributes.HitPhysicalArea += augmentper; from.SendMessage( "The Grav Rune enhances your weapon." );
		...
		public GravRune( Serial serial ) : base( serial )
		{
		}
