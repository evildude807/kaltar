...
{
	public class LorRune : Item
	{
		[Constructable]
		public LorRune() : base( 0x1F14 )
		{
			Weight = 0.2;  // ?
			Name = "Lor Rune";
			Hue = 1000;
		...
		{
			private LorRune m_LorRune;

			public InternalTarget( LorRune runeaug ) : base( 1, false, TargetFlags.None )
			{
				m_LorRune = runeaug;
			}
		...
		public LorRune( Serial serial ) : base( serial )
		{
		}
