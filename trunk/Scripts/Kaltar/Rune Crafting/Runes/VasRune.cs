...
{
	public class VasRune : Item
	{
		[Constructable]
		public VasRune() : base( 0x1F14 )
		{
			Weight = 0.2;  // ?
			Name = "Vas Rune";
			Hue = 1001;
		...
		{
			private VasRune m_VasRune;

			public InternalTarget( VasRune runeaug ) : base( 1, false, TargetFlags.None )
			{
				m_VasRune = runeaug;
			}
		 	...
		 	{ 
				...
				{ 
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							...
							Weapon.Attributes.BonusStr += augment; from.SendMessage( "The Vas Rune enhances your weapon." );
				...
				{ 
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							...
							Armor.Attributes.BonusStr += augment; from.SendMessage( "The Vas Rune enhances your armor." );
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							...
							int augmentper = ( ( Utility.Random( 5 ) ) * scalar ) + 5;
								...
								Shield.Attributes.BonusStr += augment; from.SendMessage( "The Vas Rune enhances your shield." );
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							int augment = ( ( Utility.Random( 2 ) ) * scalar ) + 1;
								...
								Clothing.Attributes.BonusStr += augment; from.SendMessage( "The Vas Rune enhances your clothing." );
				...
				{ 
					...
					{ 
						...
						{
							int augment = ( ( Utility.Random( 2 ) ) * scalar ) + 1;
								Jewel.Attributes.BonusStr += augment; from.SendMessage( "The Vas Rune enhances your jewelry." );
		...
		public VasRune( Serial serial ) : base( serial )
		{
		}
