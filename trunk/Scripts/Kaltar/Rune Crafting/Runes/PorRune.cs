...
{
	public class PorRune : Item
	{
		[Constructable]
		public PorRune() : base( 0x1F14 )
		{
			Weight = 0.2;  // ?
			Name = "Por Rune";
			Hue = 997;
		...
		{
			private PorRune m_PorRune;

			public InternalTarget( PorRune runeaug ) : base( 1, false, TargetFlags.None )
			{
				m_PorRune = runeaug;
			}
				...
				{ 
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							...
							Weapon.Attributes.BonusDex += augment; from.SendMessage( "The Por Rune enhances your weapon." );
				...
				{ 
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							...
							Armor.Attributes.BonusDex += augment; from.SendMessage( "The Por Rune enhances your armor." );
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							...
							int augmentper = ( ( Utility.Random( 5 ) ) * scalar ) + 5;
								...
								Shield.Attributes.BonusDex += augment; from.SendMessage( "The Por Rune enhances your shield." );
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							...
							int augmentper = ( ( Utility.Random( 5 ) ) * scalar ) + 5;
								...
								Clothing.Attributes.BonusDex += augment; from.SendMessage( "The Por Rune enhances your clothing." );
				...
				{ 
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							int augment = ( ( Utility.Random( 2 ) ) * scalar ) + 1;
							int augmentper = ( ( Utility.Random( 5 ) ) * scalar ) + 5;
								Jewel.Attributes.BonusDex += augment; from.SendMessage( "The Por Rune enhances your jewelry." );
		...
		public PorRune( Serial serial ) : base( serial )
		{
		}
