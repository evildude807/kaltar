...
{
	public class DelRune : Item
	{
		[Constructable]
		public DelRune() : base( 0x1F14 )
		{
			Weight = 0.2;  // ?
			Name = "Del Rune";
			Hue = 999;
		...
		{
			private DelRune m_DelRune;

			public InternalTarget( DelRune runeaug ) : base( 1, false, TargetFlags.None )
			{
				m_DelRune = runeaug;
			}
		...
		public DelRune( Serial serial ) : base( serial )
		{
		}
