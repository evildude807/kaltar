...
{
	public class OrtRune : Item
	{
		[Constructable]
		public OrtRune() : base( 0x1F14 )
		{
			Weight = 0.2;  // ?
			Name = "Ort Rune";
			Hue = 999;
		...
		{
			private OrtRune m_OrtRune;

			public InternalTarget( OrtRune runeaug ) : base( 1, false, TargetFlags.None )
			{
				m_OrtRune = runeaug;
			}
		 	...
		 	{ 
				...
				{ 
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							...
							Weapon.Attributes.BonusMana += augment; from.SendMessage( "The Ort Rune enhances your weapon." );
				...
				{ 
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							...
							Armor.Attributes.BonusMana += augment; from.SendMessage( "The Ort Rune enhances your armor." );
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							...
							int augmentper = ( ( Utility.Random( 5 ) ) * scalar ) + 5;
								...
								Shield.Attributes.BonusMana += augment; from.SendMessage( "The Ort Rune enhances your shield." );
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							int augment = ( ( Utility.Random( 3 ) ) * scalar ) + 1;
								...
								Clothing.Attributes.BonusMana += augment; from.SendMessage( "The Ort Rune enhances your clothing." );
				...
				{ 
					...
					{ 
						...
						{
							int augment = ( ( Utility.Random( 3 ) ) * scalar ) + 1;
								Jewel.Attributes.BonusMana += augment; from.SendMessage( "The Ort Rune enhances your jewelry." );
		...
		public OrtRune( Serial serial ) : base( serial )
		{
		}
