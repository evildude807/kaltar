...
{
	public class UusRune : Item
	{
		[Constructable]
		public UusRune() : base( 0x1F14 )
		{
			Weight = 0.2;  // ?
			Name = "Uus Rune";
			Hue = 998;
		...
		{
			private UusRune m_UusRune;

			public InternalTarget( UusRune runeaug ) : base( 1, false, TargetFlags.None )
			{
				m_UusRune = runeaug;
			}
				...
				{ 
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							...
							Weapon.Attributes.AttackChance += augmentper; from.SendMessage( "The Uus Rune enhances your weapon." );
				...
				{ 
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							...
							Armor.Attributes.AttackChance += augmentper; from.SendMessage( "The Uus Rune enhances your armor." );
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							...
							int augmentper = ( ( Utility.Random( 5 ) ) * scalar ) + 5;
								...
								Shield.Attributes.AttackChance += augmentper; from.SendMessage( "The Uus Rune enhances your shield." );
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							...
							int augmentper = ( ( Utility.Random( 5 ) ) * scalar ) + 5;
								...
								Clothing.Attributes.AttackChance += augmentper; from.SendMessage( "The Uus Rune enhances your clothing." );
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							...
							int augmentper = ( ( Utility.Random( 5 ) ) * scalar ) + 5;
								...
								Jewel.Attributes.AttackChance += augmentper; from.SendMessage( "The Uus Rune enhances your jewelry." );
		...
		public UusRune( Serial serial ) : base( serial )
		{
		}
