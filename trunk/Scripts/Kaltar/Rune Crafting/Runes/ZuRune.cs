...
{
	public class ZuRune : Item
	{
		[Constructable]
		public ZuRune() : base( 0x1F14 )
		{
			Weight = 0.2;  // ?
			Name = "Zu Rune";
			Hue = 1000;
		...
		{
			private ZuRune m_ZuRune;

			public InternalTarget( ZuRune runeaug ) : base( 1, false, TargetFlags.None )
			{
				m_ZuRune = runeaug;
			}
				...
				{ 
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							...
							Weapon.Attributes.EnhancePotions += augmentper; from.SendMessage( "The Zu Rune enhances your weapon." );
				...
				{ 
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							...
							Armor.Attributes.EnhancePotions += augmentper; from.SendMessage( "The Zu Rune enhances your armor." );
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							...
							int augmentper = ( ( Utility.Random( 5 ) ) * scalar ) + 5;
								...
								Shield.Attributes.EnhancePotions += augmentper; from.SendMessage( "The Zu Rune enhances your shield." );
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							...
							int augmentper = ( ( Utility.Random( 5 ) ) * scalar ) + 5;
								...
								Clothing.Attributes.EnhancePotions += augmentper; from.SendMessage( "The Zu Rune enhances your clothing." );
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							...
							int augmentper = ( ( Utility.Random( 5 ) ) * scalar ) + 5;
								...
								Jewel.Attributes.EnhancePotions += augmentper; from.SendMessage( "The Zu Rune enhances your jewelry." );
		...
		public ZuRune( Serial serial ) : base( serial )
		{
		}
