...
{
	public class CorpRune : Item
	{
		[Constructable]
		public CorpRune() : base( 0x1F14 )
		{
			Weight = 0.2;  // ?
			Name = "Corp Rune";
			Hue = 998;
		...
		{
			private CorpRune m_CorpRune;

			public InternalTarget( CorpRune runeaug ) : base( 1, false, TargetFlags.None )
			{
				m_CorpRune = runeaug;
			}
		 	...
		 	{ 
				...
				{ 
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							...
							Weapon.Attributes.SpellDamage += augment; from.SendMessage( "The Corp Rune enhances your weapon." );
				...
				{ 
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							...
							Armor.Attributes.SpellDamage += augment; from.SendMessage( "The Corp Rune enhances your armor." );
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							...
							int augmentper = ( ( Utility.Random( 5 ) ) * scalar ) + 5;
								...
								Shield.Attributes.SpellDamage += augment; from.SendMessage( "The Corp Rune enhances your shield." );
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							int augment = ( ( Utility.Random( 3 ) ) * scalar ) + 1;
								...
								Clothing.Attributes.SpellDamage += augment; from.SendMessage( "The Corp Rune enhances your clothing." );
				...
				{ 
					...
					{ 
						...
						{
							int augment = ( ( Utility.Random( 3 ) ) * scalar ) + 1;
								Jewel.Attributes.SpellDamage += augment; from.SendMessage( "The Corp Rune ennhances your jewelry." );
		...
		public CorpRune( Serial serial ) : base( serial )
		{
		}
