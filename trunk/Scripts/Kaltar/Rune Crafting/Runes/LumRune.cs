...
{
	public class LumRune : Item
	{
		[Constructable]
		public LumRune() : base( 0x1F14 )
		{
			Weight = 0.2;  // ?
			Name = "Lum Rune";
			Hue = 999;
		...
		{
			private LumRune m_LumRune;

			public InternalTarget( LumRune runeaug ) : base( 1, false, TargetFlags.None )
			{
				m_LumRune = runeaug;
			}
				...
				{ 
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							...
							Weapon.WeaponAttributes.LowerStatReq += augmentper; from.SendMessage( "The Lum Rune enhances your weapon." );
				...
				{ 
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							...
							Armor.ArmorAttributes.LowerStatReq += augmentper; from.SendMessage( "The Lum Rune enhances your armor." );
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							...
							int augmentper = ( ( Utility.Random( 5 ) ) * scalar ) + 5;
								...
								Shield.ArmorAttributes.LowerStatReq += augmentper; from.SendMessage( "The Lum Rune enhances your shield." );
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							...
							int augmentper = ( ( Utility.Random( 5 ) ) * scalar ) + 5;
								...
								Clothing.ClothingAttributes.LowerStatReq+= augmentper; from.SendMessage( "The Lum Rune enhances your clothing." );
		...
		public LumRune( Serial serial ) : base( serial )
		{
		}
