...
{
	public class FrioRune : Item
	{
		[Constructable]
		public FrioRune() : base( 0x1F14 )
		{
			Weight = 0.2;  // ?
			Name = "Frio Rune";
			Hue = 999;
		...
		{
			private FrioRune m_FrioRune;

			public InternalTarget( FrioRune runeaug ) : base( 1, false, TargetFlags.None )
			{
				m_FrioRune = runeaug;
			}
				...
				{ 
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							...
							Weapon.WeaponAttributes.HitColdArea += augmentper; from.SendMessage( "The Frio Rune enhances your weapon." );
		...
		public FrioRune( Serial serial ) : base( serial )
		{
		}
