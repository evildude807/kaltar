...
{
	public class SanctRune : Item
	{
		[Constructable]
		public SanctRune() : base( 0x1F14 )
		{
			Weight = 0.2;  // ?
			Name = "Sanct Rune";
			Hue = 1000;
		...
		{
			private SanctRune m_SanctRune;

			public InternalTarget( SanctRune runeaug ) : base( 1, false, TargetFlags.None )
			{
				m_SanctRune = runeaug;
			}
				...
				{ 
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							...
							Weapon.Attributes.ReflectPhysical += augmentper; from.SendMessage( "The Sanct Rune enhances your weapon." );
				...
				{ 
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							...
							Armor.Attributes.ReflectPhysical += augmentper; from.SendMessage( "The Sanct Rune enhances your armor." );
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							...
							int augmentper = ( ( Utility.Random( 5 ) ) * scalar ) + 5;
								...
								Shield.Attributes.ReflectPhysical += augmentper; from.SendMessage( "The Sanct Rune enhances your shield." );
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							...
							int augmentper = ( ( Utility.Random( 5 ) ) * scalar ) + 5;
								...
								Clothing.Attributes.ReflectPhysical += augmentper; from.SendMessage( "The Sanct Rune enhances your clothing." );
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							...
							int augmentper = ( ( Utility.Random( 5 ) ) * scalar ) + 5;
								...
								Jewel.Attributes.ReflectPhysical += augmentper; from.SendMessage( "The Sanct Rune enhances your jewelry." );
		...
		public SanctRune( Serial serial ) : base( serial )
		{
		}
