...
{
	public class ManiRune : Item
	{
		[Constructable]
		public ManiRune() : base( 0x1F14 )
		{
			Weight = 0.2;  // ?
			Name = "Mani Rune";
			Hue = 1001;
		...
		{
			private ManiRune m_ManiRune;

			public InternalTarget( ManiRune runeaug ) : base( 1, false, TargetFlags.None )
			{
				m_ManiRune = runeaug;
			}
		 	...
		 	{ 
				...
				{ 
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							...
							Weapon.Attributes.BonusHits += augment; from.SendMessage( "The Mani Rune enhances your weapon." );
				...
				{ 
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							...
							Armor.Attributes.BonusHits += augment; from.SendMessage( "The Mani Rune enhances your armor." );
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							...
							int augmentper = ( ( Utility.Random( 5 ) ) * scalar ) + 5;
								...
								Shield.Attributes.BonusHits += augment; from.SendMessage( "The Mani Rune enhances your shield." );
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							int augment = ( ( Utility.Random( 2 ) ) * scalar ) + 1;
								...
								Clothing.Attributes.BonusHits += augment; from.SendMessage( "The Mani Rune enhances your clothing." );
				...
				{ 
					...
					{ 
						...
						{
							int augment = ( ( Utility.Random( 2 ) ) * scalar ) + 1;
								Jewel.Attributes.BonusHits += augment; from.SendMessage( "The Mani Rune enhances your jewelry." );
		...
		public ManiRune( Serial serial ) : base( serial )
		{
		}
