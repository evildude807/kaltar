...
{
	public class RelRune : Item
	{
		[Constructable]
		public RelRune() : base( 0x1F14 )
		{
			Weight = 0.2;  // ?
			Name = "Rel Rune";
			Hue = 999;
		...
		{
			private RelRune m_RelRune;

			public InternalTarget( RelRune runeaug ) : base( 1, false, TargetFlags.None )
			{
				m_RelRune = runeaug;
			}
				...
				{ 
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							...
							Weapon.WeaponAttributes.SelfRepair += augment; from.SendMessage( "The Rel Rune enhances your weapon." );
				...
				{ 
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							...
							Armor.ArmorAttributes.SelfRepair += augment; from.SendMessage( "The Rel Rune enhances your armor." );
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							...
							int augmentper = ( ( Utility.Random( 5 ) ) * scalar ) + 5;
								...
								Shield.ArmorAttributes.SelfRepair += augment; from.SendMessage( "The Rel Rune enhances your shield." );
		...
		public RelRune( Serial serial ) : base( serial )
		{
		}
