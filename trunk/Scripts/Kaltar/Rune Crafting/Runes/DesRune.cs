...
{
	public class DesRune : Item
	{
		[Constructable]
		public DesRune() : base( 0x1F14 )
		{
			Weight = 0.2;  // ?
			Name = "Des Rune";
			Hue = 1000;
		...
		{
			private DesRune m_DesRune;

			public InternalTarget( DesRune runeaug ) : base( 1, false, TargetFlags.None )
			{
				m_DesRune = runeaug;
			}
				...
				{ 
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							...
							Weapon.WeaponAttributes.HitLowerAttack += augmentper; from.SendMessage( "The Des Rune enhances your weapon." );
		...
		public DesRune( Serial serial ) : base( serial )
		{
		}
