...
{
	public class OmRune : Item
	{
		[Constructable]
		public OmRune() : base( 0x1F14 )
		{
			Weight = 0.2;  // ?
			Name = "Om Rune";
			Hue = 1001;
		...
		{
			private OmRune m_OmRune;

			public InternalTarget( OmRune runeaug ) : base( 1, false, TargetFlags.None )
			{
				m_OmRune = runeaug;
			}
		 	...
		 	{ 
				...
				{ 
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							...
							Weapon.Attributes.RegenMana += augment; from.SendMessage( "The Om Rune enhances your weapon." );
				...
				{ 
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							...
							Armor.Attributes.RegenMana += augment; from.SendMessage( "The Om Rune enhances your armor." );
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							...
							int augmentper = ( ( Utility.Random( 5 ) ) * scalar ) + 5;
								...
								Shield.Attributes.RegenMana += augment; from.SendMessage( "The Om Rune enhances your shield." );
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							int augment = ( ( Utility.Random( 3 ) ) * scalar ) + 1;
								...
								Clothing.Attributes.RegenMana += augment; from.SendMessage( "The Om Rune enhances your clothing." );
				...
				{ 
					...
					{ 
						...
						{
							int augment = ( ( Utility.Random( 3 ) ) * scalar ) + 1;
								Jewel.Attributes.RegenMana+= augment; from.SendMessage( "The Om Rune enhances your jewelry." );
		...
		public OmRune( Serial serial ) : base( serial )
		{
		}
