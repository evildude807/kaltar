...
{
	public class TymRune : Item
	{
		[Constructable]
		public TymRune() : base( 0x1F14 )
		{
			Weight = 0.2;  // ?
			Name = "Tym Rune";
			Hue = 1000;
		...
		{
			private TymRune m_TymRune;

			public InternalTarget( TymRune runeaug ) : base( 1, false, TargetFlags.None )
			{
				m_TymRune = runeaug;
			}
				...
				{ 
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							...
							Weapon.Attributes.WeaponSpeed += augmentper; from.SendMessage( "The Tym Rune enhances your weapon." );
				...
				{ 
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							...
							Armor.Attributes.WeaponSpeed += augmentper; from.SendMessage( "The Tym Rune enhances your armor." );
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							...
							int augmentper = ( ( Utility.Random( 3 ) ) * scalar ) + 5;
								...
								Shield.Attributes.WeaponSpeed += augmentper; from.SendMessage( "The Tym Rune enhances your shield." );
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							...
							int augmentper = ( ( Utility.Random( 3 ) ) * scalar ) + 5;
								...
								Clothing.Attributes.WeaponSpeed += augmentper; from.SendMessage( "The Tym Rune enhances your clothing." );
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							...
							int augmentper = ( ( Utility.Random( 3 ) ) * scalar ) + 5;
								...
								Jewel.Attributes.WeaponSpeed += augmentper; from.SendMessage( "The Tym Rune enhances your jewelry." );
		...
		public TymRune( Serial serial ) : base( serial )
		{
		}
