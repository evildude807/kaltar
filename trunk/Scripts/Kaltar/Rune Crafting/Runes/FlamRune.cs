...
{
	public class FlamRune : Item
	{
		[Constructable]
		public FlamRune() : base( 0x1F14 )
		{
			Weight = 0.2;  // ?
			Name = "Flam Rune";
			Hue = 1000;
		...
		{
			private FlamRune m_FlamRune;

			public InternalTarget( FlamRune runeaug ) : base( 1, false, TargetFlags.None )
			{
				m_FlamRune = runeaug;
			}
				...
				{ 
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							...
							Weapon.WeaponAttributes.ResistFireBonus += augmentper; from.SendMessage( "The Flam Rune enhances your weapon." );
				...
				{ 
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							...
							Armor.FireBonus += augment; from.SendMessage( "The Flam Rune enhances your armor." );
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							...
							int augmentper = ( ( Utility.Random( 5 ) ) * scalar ) + 5;
								...
								Shield.FireBonus += augment; from.SendMessage( "The Flam Rune enhances your shield." );
				...
				{ 
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							int augment = ( ( Utility.Random( 3 ) ) * scalar ) + 1;
							int augmentper = ( ( Utility.Random( 5 ) ) * scalar ) + 5;
								Jewel.Resistances.Fire += augmentper; from.SendMessage( "The Flam Rune ennhances your jewelry." );
		...
		public FlamRune( Serial serial ) : base( serial )
		{
		}
