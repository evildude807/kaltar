...
{
	public class NoxRune : Item
	{
		[Constructable]
		public NoxRune() : base( 0x1F14 )
		{
			Weight = 0.2;  // ?
			Name = "Nox Rune";
			Hue = 1000;
		...
		{
			private NoxRune m_NoxRune;

			public InternalTarget( NoxRune runeaug ) : base( 1, false, TargetFlags.None )
			{
				m_NoxRune = runeaug;
			}
				...
				{ 
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							...
							Weapon.WeaponAttributes.ResistPoisonBonus += augmentper; from.SendMessage( "The Flam Rune enhances your weapon." );
				...
				{ 
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							...
							Armor.PoisonBonus += augment; from.SendMessage( "The Flam Rune enhances your armor." );
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							...
							int augmentper = ( ( Utility.Random( 5 ) ) * scalar ) + 5;
								...
								Shield.PoisonBonus += augment; from.SendMessage( "The Flam Rune enhances your shield." );
				...
				{ 
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							int augment = ( ( Utility.Random( 3 ) ) * scalar ) + 1;
							int augmentper = ( ( Utility.Random( 5 ) ) * scalar ) + 5;
								Jewel.Resistances.Poison += augmentper; from.SendMessage( "The Flam Rune ennhances your jewelry." );
		...
		public NoxRune( Serial serial ) : base( serial )
		{
		}
