...
namespace Kaltar.Habilidades 
{
    ...
    public class ConfirmarAprenderHabilidade : Gump {

        private Jogador jogador = null;
        private int IdHabilidade;
        private AprenderHabilidade AprenderHabilidadeGump = null;

        public ConfirmarAprenderHabilidade(Jogador jogador, int IdHabilidade, AprenderHabilidade gump)
            : base(10, 30)
        {
            ...
            jogador.CloseGump(typeof(ConfirmarAprenderHabilidade));
