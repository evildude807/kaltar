...
{
	public class ToqueDaCuraSpell : SeminaristaSpell {
		...
		public void Target( Mobile m ) {
			...
			if ( !Caster.CanSee( m ) ) {
				...
				//m.Heal( (int)toHeal );
				SpellHelper.Heal( (int)toHeal, m, Caster, true);
			}
		...
		private class InternalTarget : Target {
			private ToqueDaCuraSpell m_Owner;

			public InternalTarget( ToqueDaCuraSpell owner ) : base( 1, false, TargetFlags.Beneficial ) {
				m_Owner = owner;
			}
