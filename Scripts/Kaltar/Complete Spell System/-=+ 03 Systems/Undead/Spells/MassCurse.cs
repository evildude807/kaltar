...
{
	public class UndeadMassCurseSpell : UndeadSpell
	{
		...
		public UndeadMassCurseSpell( Mobile caster, Item scroll ) : base( caster, scroll, m_Info )
		{
		}
		...
		{
			private UndeadMassCurseSpell m_Owner;
			
			public InternalTarget( UndeadMassCurseSpell owner ) : base( 12, true, TargetFlags.None )
			{
				m_Owner = owner;
			}
