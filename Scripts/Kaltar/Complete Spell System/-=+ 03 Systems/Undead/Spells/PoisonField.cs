...
{
	public class UndeadPoisonFieldSpell : UndeadSpell
	{
		...
		public UndeadPoisonFieldSpell( Mobile caster, Item scroll ) : base( caster, scroll, m_Info )
		{
		}
		...
		{
			private UndeadPoisonFieldSpell m_Owner;
			
			public InternalTarget( UndeadPoisonFieldSpell owner ) : base( 12, true, TargetFlags.None )
			{
				m_Owner = owner;
			}
