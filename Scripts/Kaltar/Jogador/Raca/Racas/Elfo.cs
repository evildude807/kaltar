...
{
    public class Elfo : Race, IKaltarRaca
    {
        public Elfo(int raceID, int raceIndex) : base( raceID, raceIndex, "Elfo", "Elfos", 605, 606, 607, 608, Expansion.None)
		{
		}
        ...
        public int MaxDex { get { return 120; } }
