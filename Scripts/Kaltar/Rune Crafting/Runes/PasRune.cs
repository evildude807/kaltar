...
{
	public class PasRune : Item
	{
		[Constructable]
		public PasRune() : base( 0x1F14 )
		{
			Weight = 0.2;  // ?
			Name = "Pas Rune";
			Hue = 998;
		...
		{
			private PasRune m_PasRune;

			public InternalTarget( PasRune runeaug ) : base( 1, false, TargetFlags.None )
			{
				m_PasRune = runeaug;
			}
				...
				{ 
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							...
							Weapon.Attributes.LowerManaCost += augmentper; from.SendMessage( "The Pas Rune enhances your weapon." );
				...
				{ 
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							...
							Armor.Attributes.LowerManaCost += augmentper; from.SendMessage( "The Pas Rune enhances your armor." );
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							...
							int augmentper = ( ( Utility.Random( 3 ) ) * scalar ) + 5;
								...
								Shield.Attributes.LowerManaCost += augmentper; from.SendMessage( "The Pas Rune enhances your shield." );
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							...
							int augmentper = ( ( Utility.Random( 3 ) ) * scalar ) + 5;
								...
								Clothing.Attributes.LowerManaCost += augmentper; from.SendMessage( "The Pas Rune enhances your clothing." );
				...
				{ 
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							int augment = ( ( Utility.Random( 3 ) ) * scalar ) + 1;
							int augmentper = ( ( Utility.Random( 3 ) ) * scalar ) + 5;
								Jewel.Attributes.LowerManaCost += augmentper; from.SendMessage( "The Pas Rune enhances your jewelry." );
		...
		public PasRune( Serial serial ) : base( serial )
		{
		}
