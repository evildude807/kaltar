...
{
	public class SarRune : Item
	{
		[Constructable]
		public SarRune() : base( 0x1F14 )
		{
			Weight = 0.2;  // ?
			Name = "Sar Rune";
			Hue = 997;
		...
		{
			private SarRune m_SarRune;

			public InternalTarget( SarRune runeaug ) : base( 1, false, TargetFlags.None )
			{
				m_SarRune = runeaug;
			}
				...
				{ 
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							...
							Weapon.Attributes.WeaponDamage += augmentper; from.SendMessage( "The Sar Rune enhances your weapon." );
				...
				{ 
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							...
							Armor.Attributes.WeaponDamage += augmentper; from.SendMessage( "The Sar Rune enhances your armor." );
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							...
							int augmentper = ( ( Utility.Random( 3 ) ) * scalar ) + 5;
								...
								Shield.Attributes.WeaponDamage += augmentper; from.SendMessage( "The Sar Rune enhances your shield." );
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							...
							int augmentper = ( ( Utility.Random( 3 ) ) * scalar ) + 5;
								...
								Clothing.Attributes.WeaponDamage += augmentper; from.SendMessage( "The Sar Rune enhances your clothing." );
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							...
							int augmentper = ( ( Utility.Random( 3 ) ) * scalar ) + 5;
								...
								Jewel.Attributes.WeaponDamage += augmentper; from.SendMessage( "The Sar Rune enhances your jewelry." );
		...
		public SarRune( Serial serial ) : base( serial )
		{
		}
