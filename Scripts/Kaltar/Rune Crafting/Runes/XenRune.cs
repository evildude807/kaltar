...
{
	public class XenRune : Item
	{
		[Constructable]
		public XenRune() : base( 0x1F14 )
		{
			Weight = 0.2;  // ?
			Name = "Xen Rune";
			Hue = 999;
		...
		{
			private XenRune m_XenRune;

			public InternalTarget( XenRune runeaug ) : base( 1, false, TargetFlags.None )
			{
				m_XenRune = runeaug;
			}
				...
				{ 
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							...
							Weapon.WeaponAttributes.HitLightning += augmentper; from.SendMessage( "The Xen Rune enhances your weapon." );
		...
		public XenRune( Serial serial ) : base( serial )
		{
		}
