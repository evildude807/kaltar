...
{
	public class KalRune : Item
	{
		[Constructable]
		public KalRune() : base( 0x1F14 )
		{
			Weight = 0.2;  // ?
			Name = "Kal Rune";
			Hue = 999;
		...
		{
			private KalRune m_KalRune;

			public InternalTarget( KalRune runeaug ) : base( 1, false, TargetFlags.None )
			{
				m_KalRune = runeaug;
			}
				...
				{ 
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							...
							Weapon.WeaponAttributes.HitFireball += augmentper; from.SendMessage( "The Kal Rune enhances your weapon." );
		...
		public KalRune( Serial serial ) : base( serial )
		{
		}
