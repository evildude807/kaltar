...
{
	public class BehRune : Item
	{
		[Constructable]
		public BehRune() : base( 0x1F14 )
		{
			Weight = 0.2;  // ?
			Name = "Beh Rune";
			Hue = 1001;
		...
		{
			private BehRune m_BehRune;

			public InternalTarget( BehRune runeaug ) : base( 1, false, TargetFlags.None )
			{
				m_BehRune = runeaug;
			}
		 	...
		 	{ 
				...
				{ 
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							...
							Weapon.Attributes.RegenStam += augment; from.SendMessage( "The Beh Rune enhances your weapon." );
				...
				{ 
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							...
							Armor.Attributes.RegenStam += augment; from.SendMessage( "The Beh Rune enhances your armor." );
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							...
							int augmentper = ( ( Utility.Random( 5 ) ) * scalar ) + 5;
								...
								Shield.Attributes.RegenStam += augment; from.SendMessage( "The Beh Rune enhances your shield." );
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							int augment = ( ( Utility.Random( 3 ) ) * scalar ) + 1;
								...
								Clothing.Attributes.RegenStam += augment; from.SendMessage( "The Beh Rune enhances your clothing." );
				...
				{ 
					...
					{ 
						...
						{
							int augment = ( ( Utility.Random( 3 ) ) * scalar ) + 1;
								Jewel.Attributes.RegenStam+= augment; from.SendMessage( "The Beh Rune enhances your jewelry." );
		...
		public BehRune( Serial serial ) : base( serial )
		{
		}
