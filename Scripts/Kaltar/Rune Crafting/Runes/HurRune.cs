...
{
	public class HurRune : Item
	{
		[Constructable]
		public HurRune() : base( 0x1F14 )
		{
			Weight = 0.2;  // ?
			Name = "Hur Rune";
			Hue = 999;
		...
		{
			private HurRune m_HurRune;

			public InternalTarget( HurRune runeaug ) : base( 1, false, TargetFlags.None )
			{
				m_HurRune = runeaug;
			}
		...
		public HurRune( Serial serial ) : base( serial )
		{
		}
