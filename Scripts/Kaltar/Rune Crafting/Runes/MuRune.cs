...
{
	public class MuRune : Item
	{
		[Constructable]
		public MuRune() : base( 0x1F14 )
		{
			Weight = 0.2;  // ?
			Name = "Mu Rune";
			Hue = 1001;
		...
		{
			private MuRune m_MuRune;

			public InternalTarget( MuRune runeaug ) : base( 1, false, TargetFlags.None )
			{
				m_MuRune = runeaug;
			}
		 	...
		 	{ 
				...
				{ 
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							...
							Weapon.Attributes.RegenHits += augment; from.SendMessage( "The Mu Rune enhances your weapon." );
				...
				{ 
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							...
							Armor.Attributes.RegenHits += augment; from.SendMessage( "The Mu Rune enhances your armor." );
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							...
							int augmentper = ( ( Utility.Random( 5 ) ) * scalar ) + 5;
								...
								Shield.Attributes.RegenHits += augment; from.SendMessage( "The Mu Rune enhances your shield." );
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							int augment = ( ( Utility.Random( 3 ) ) * scalar ) + 1;
								...
								Clothing.Attributes.RegenHits += augment; from.SendMessage( "The Mu Rune enhances your clothing." );
				...
				{ 
					...
					{ 
						...
						{
							int augment = ( ( Utility.Random( 3 ) ) * scalar ) + 1;
								Jewel.Attributes.RegenHits+= augment; from.SendMessage( "The Mu Rune enhances your jewelry." );
		...
		public MuRune( Serial serial ) : base( serial )
		{
		}
		...
		public override void AddNameProperty( ObjectPropertyList list )
		{
			...
			list.Add( "Hit Point Regeneration" );
		}
	}
}