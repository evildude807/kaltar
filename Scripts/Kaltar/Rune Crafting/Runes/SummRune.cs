...
{
	public class SummRune : Item
	{
		[Constructable]
		public SummRune() : base( 0x1F14 )
		{
			Weight = 0.2;  // ?
			Name = "Summ Rune";
			Hue = 996;
		...
		{
			private SummRune m_SummRune;

			public InternalTarget( SummRune runeaug ) : base( 1, false, TargetFlags.None )
			{
				m_SummRune = runeaug;
			}
				...
				{ 
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							...
							Weapon.Attributes.CastRecovery += augment; from.SendMessage( "The Summ Rune enhances your weapon." );
				...
				{ 
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							...
							Armor.Attributes.CastRecovery += augment; from.SendMessage( "The Summ Rune enhances your armor." );
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							int augment = ( ( Utility.Random( 3 ) ) * scalar ) + 1;
								...
								Shield.Attributes.CastRecovery += augment; from.SendMessage( "The Summ Rune enhances your shield." );
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							int augment = ( ( Utility.Random( 3 ) ) * scalar ) + 1;
								...
								Clothing.Attributes.CastRecovery += augment; from.SendMessage( "The Summ Rune enhances your clothing." );
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							int augment = ( ( Utility.Random( 3 ) ) * scalar ) + 1;
								...
								Jewel.Attributes.CastRecovery += augment; from.SendMessage( "The Summ Rune enhances your jewelry." );
		...
		public SummRune( Serial serial ) : base( serial )
		{
		}
