...
{
	public class CahRune : Item
	{
		[Constructable]
		public CahRune() : base( 0x1F14 )
		{
			Weight = 0.2;  // ?
			Name = "Cah Rune";
			Hue = 997;
		...
		{
			private CahRune m_CahRune;

			public InternalTarget( CahRune runeaug ) : base( 1, false, TargetFlags.None )
			{
				m_CahRune = runeaug;
			}
				...
				{ 
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							...
							Weapon.WeaponAttributes.MageWeapon += augment; from.SendMessage( "The Cah Rune enhances your weapon." );
				...
				{ 
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							...
							Armor.ArmorAttributes.MageArmor += augment; from.SendMessage( "The Cah Rune enhances your armor." );
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							...
							int augmentper = ( ( Utility.Random( 5 ) ) * scalar ) + 5;
								...
								Shield.ArmorAttributes.MageArmor += augment; from.SendMessage( "The Cah Rune enhances your shield." );
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							...
							int augmentper = ( ( Utility.Random( 5 ) ) * scalar ) + 5;
								...
								Clothing.ClothingAttributes.MageArmor += augment; from.SendMessage( "The Cah Rune enhances your clothing." );
		...
		public CahRune( Serial serial ) : base( serial )
		{
		}
