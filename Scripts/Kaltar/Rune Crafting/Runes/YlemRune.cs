...
{
	public class YlemRune : Item
	{
		[Constructable]
		public YlemRune() : base( 0x1F14 )
		{
			Weight = 0.2;  // ?
			Name = "Ylem Rune";
			Hue = 998;
		...
		{
			private YlemRune m_YlemRune;

			public InternalTarget( YlemRune runeaug ) : base( 1, false, TargetFlags.None )
			{
				m_YlemRune = runeaug;
			}
				...
				{ 
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							...
							int augmentper = ( ( Utility.Random( 3 ) ) * scalar ) + 5;

							Weapon.Attributes.LowerRegCost += augmentper; from.SendMessage( "The Ylem Rune enhances your weapon." );
				...
				{ 
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							...
							Armor.Attributes.LowerRegCost += augmentper; from.SendMessage( "The Ylem Rune enhances your armor." );
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							...
							int augmentper = ( ( Utility.Random( 3 ) ) * scalar ) + 5;
								...
								Shield.Attributes.LowerRegCost += augmentper; from.SendMessage( "The Ylem Rune enhances your shield." );
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							...
							int augmentper = ( ( Utility.Random( 3 ) ) * scalar ) + 5;
								...
								Clothing.Attributes.LowerRegCost += augmentper; from.SendMessage( "The Ylem Rune enhances your clothing." );
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							...
							int augmentper = ( ( Utility.Random( 3 ) ) * scalar ) + 5;
								...
								Jewel.Attributes.LowerRegCost += augmentper; from.SendMessage( "The Ylem Rune enhances your jewelry." );
		...
		public YlemRune( Serial serial ) : base( serial )
		{
		}
