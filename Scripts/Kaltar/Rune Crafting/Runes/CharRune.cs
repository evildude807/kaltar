...
{
	public class CharRune : Item
	{
		[Constructable]
		public CharRune() : base( 0x1F14 )
		{
			Weight = 0.2;  // ?
			Name = "Char Rune";
			Hue = 997;
		...
		{
			private CharRune m_CharRune;

			public InternalTarget( CharRune runeaug ) : base( 1, false, TargetFlags.None )
			{
				m_CharRune = runeaug;
			}
				...
				{ 
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							...
							Weapon.WeaponAttributes.HitLowerDefend += augmentper; from.SendMessage( "The Char Rune enhances your weapon." );
