...
{
	public class RaRune : Item
	{
		[Constructable]
		public RaRune() : base( 0x1F14 )
		{
			Weight = 0.2;  // ?
			Name = "Ra Rune";
			Hue = 996;
		...
		{
			private RaRune m_RaRune;

			public InternalTarget( RaRune runeaug ) : base( 1, false, TargetFlags.None )
			{
				m_RaRune = runeaug;
			}
				...
				{ 
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							...
							Weapon.Attributes.DefendChance += augmentper; from.SendMessage( "The Ra Rune enhances your weapon." );
				...
				{ 
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							...
							Armor.Attributes.DefendChance += augmentper; from.SendMessage( "The Ra Rune enhances your armor." );
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							...
							int augmentper = ( ( Utility.Random( 5 ) ) * scalar ) + 5;
								...
								Shield.Attributes.DefendChance += augmentper; from.SendMessage( "The Ra Rune enhances your shield." );
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							...
							int augmentper = ( ( Utility.Random( 5 ) ) * scalar ) + 5;
								...
								Clothing.Attributes.DefendChance += augmentper; from.SendMessage( "The Ra Rune enhances your clothing." );
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							...
							int augmentper = ( ( Utility.Random( 5 ) ) * scalar ) + 5;
								...
								Jewel.Attributes.DefendChance += augmentper; from.SendMessage( "The Ra Rune enhances your jewelry." );
		...
		public RaRune( Serial serial ) : base( serial )
		{
		}
