...
{
	public class FurisRune : Item
	{
		[Constructable]
		public FurisRune() : base( 0x1F14 )
		{
			Weight = 0.2;  // ?
			Name = "Furis Rune";
			Hue = 997;
		...
		{
			private FurisRune m_FurisRune;

			public InternalTarget( FurisRune runeaug ) : base( 1, false, TargetFlags.None )
			{
				m_FurisRune = runeaug;
			}
				...
				{ 
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							...
							Weapon.WeaponAttributes.HitEnergyArea += augmentper; from.SendMessage( "The Furis Rune enhances your weapon." );
		...
		public FurisRune( Serial serial ) : base( serial )
		{
		}
