...
{
	public class JuxRune : Item
	{
		[Constructable]
		public JuxRune() : base( 0x1F14 )
		{
			Weight = 0.2;  // ?
			Name = "Jux Rune";
			Hue = 998;
		...
		{
			private JuxRune m_JuxRune;

			public InternalTarget( JuxRune runeaug ) : base( 1, false, TargetFlags.None )
			{
				m_JuxRune = runeaug;
			}
		...
		public JuxRune( Serial serial ) : base( serial )
		{
		}
