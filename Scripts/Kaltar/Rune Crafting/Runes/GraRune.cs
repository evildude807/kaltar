...
{
	public class GraRune : Item
	{
		[Constructable]
		public GraRune() : base( 0x1F14 )
		{
			Weight = 0.2;  // ?
			Name = "Gra Rune";
			Hue = 997;
		...
		{
			private GraRune m_GraRune;

			public InternalTarget( GraRune runeaug ) : base( 1, false, TargetFlags.None )
			{
				m_GraRune = runeaug;
			}
				...
				{ 
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							...
							Weapon.WeaponAttributes.HitLeechHits += augmentper; from.SendMessage( "The Gra Rune enhances your weapon." );
		...
		public GraRune( Serial serial ) : base( serial )
		{
		}
