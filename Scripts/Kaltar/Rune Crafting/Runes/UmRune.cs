...
{
	public class UmRune : Item
	{
		[Constructable]
		public UmRune() : base( 0x1F14 )
		{
			Weight = 0.2;  // ?
			Name = "Um Rune";
			Hue = 999;
		...
		{
			private UmRune m_UmRune;

			public InternalTarget( UmRune runeaug ) : base( 1, false, TargetFlags.None )
			{
				m_UmRune = runeaug;
			}
				...
				{ 
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							...
							Weapon.Attributes.CastSpeed += augment; from.SendMessage( "The Um Rune enhances your weapon." );
				...
				{ 
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							...
							Armor.Attributes.CastSpeed += augment; from.SendMessage( "The Um Rune enhances your armor." );
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							...
							int augmentper = ( ( Utility.Random( 5 ) ) * scalar ) + 5;
								...
								Shield.Attributes.CastSpeed += augment; from.SendMessage( "The Um Rune enhances your shield." );
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							...
							int augmentper = ( ( Utility.Random( 5 ) ) * scalar ) + 5;
								...
								Clothing.Attributes.CastSpeed += augment; from.SendMessage( "The Um Rune enhances your clothing." );
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							...
							int augmentper = ( ( Utility.Random( 5 ) ) * scalar ) + 5;
								...
								Jewel.Attributes.CastSpeed += augment; from.SendMessage( "The Um Rune enhances your jewelry." );
		...
		public UmRune( Serial serial ) : base( serial )
		{
		}
