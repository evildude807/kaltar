...
{
	public class InRune : Item
	{
		[Constructable]
		public InRune() : base( 0x1F14 )
		{
			Weight = 0.2;  // ?
			Name = "In Rune";
			Hue = 998;
		...
		{
			private InRune m_InRune;

			public InternalTarget( InRune runeaug ) : base( 1, false, TargetFlags.None )
			{
				m_InRune = runeaug;
			}
		 	...
		 	{ 
				...
				{ 
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							...
							Weapon.Attributes.Luck += augment; from.SendMessage( "The In Rune enhances your weapon." );
				...
				{ 
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							...
							Armor.Attributes.Luck += augment; from.SendMessage( "The In Rune enhances your armor." );
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							...
							int augmentper = ( ( Utility.Random( 5 ) ) * scalar ) + 5;
								...
								Shield.Attributes.Luck += augment; from.SendMessage( "The In Rune enhances your shield." );
					...
					{ 
						...
						if ( DestroyChance > 0 ) // Success
						{
							int augment = ( ( Utility.Random( 3 ) ) * scalar ) + 1;
								...
								Clothing.Attributes.Luck += augment; from.SendMessage( "The In Rune enhances your clothing." );
				...
				{ 
					...
					{ 
						...
						{
							int augment = ( ( Utility.Random( 3 ) ) * scalar ) + 1;
								Jewel.Attributes.Luck += augment; from.SendMessage( "The In Rune enhances your jewelry." );
		...
		public InRune( Serial serial ) : base( serial )
		{
		}
