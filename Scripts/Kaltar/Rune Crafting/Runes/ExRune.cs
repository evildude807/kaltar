...
{
	public class ExRune : Item
	{
		[Constructable]
		public ExRune() : base( 0x1F14 )
		{
			Weight = 0.2;  // ?
			Name = "Ex Rune";
			Hue = 1001;
		...
		{
			private ExRune m_ExRune;

			public InternalTarget( ExRune runeaug ) : base( 1, false, TargetFlags.None )
			{
				m_ExRune = runeaug;
			}
		...
		public ExRune( Serial serial ) : base( serial )
		{
		}
