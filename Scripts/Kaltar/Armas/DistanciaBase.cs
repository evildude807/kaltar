...
{
	/// <summary>
	/// Description of DistanciaBase.
	/// </summary>
	public abstract class DistanciaBase : Arma {

		#region kaltar
		public override CategoriaArma categoria { get{return CategoriaArma.distancia;} }
		#endregion		
		...
		public DistanciaBase( int itemID ) : base( itemID ) {

		}

		public DistanciaBase( Serial serial ) : base( serial ) {
		}
