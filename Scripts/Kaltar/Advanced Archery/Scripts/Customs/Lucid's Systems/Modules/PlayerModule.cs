...
namespace Server.ACC.CM
{
	...
	public class PlayerModule : Module
	{
		...
		//--<< Event System >>--------------------[Start 1/2]
		private TeamType m_Team;
		//--<< Event System >>--------------------[End 1/2]		
		
		//--<<Duel System>>-----------------------[Start 1/1]
		private int m_Score, m_Wins, m_Losses, m_GameLevel;
		private bool m_Banned;
		private static ArrayList m_Duelists = new ArrayList();
		private bool m_RegenHits = false;
		...
		//--<<Duel System>>-----------------------[Start 2/1]
		public static ArrayList Duelists{ get{ return m_Duelists; } }
		...
		public int GameLevel
		{
			...
			set
			{
				...
				if ( ( m_Wins + m_Losses ) >= 5 && !m_Duelists.Contains( this ) )
					m_Duelists.Add( this );
			}
		}
		
		[CommandProperty(AccessLevel.Counselor, AccessLevel.GameMaster)]
		public bool BannedFromPits
		{
			get{ return m_Banned; }
			set
			{
				...
				if ( value )
				{
					...
					if ( m_Duelists.Contains( this ) )
						m_Duelists.Remove( this );
				}
			}
		}
		...
		[CommandProperty(AccessLevel.Counselor, AccessLevel.Administrator)]
		public bool SetCanRegenHits{ get{ return m_RegenHits; } set{ m_RegenHits = value; } }
		
				
		[CommandProperty(AccessLevel.Counselor, AccessLevel.Administrator)]
		public bool OpenRequest{ get{ return m_Request; } set{ m_Request = value; } }
		//--<<Duel System>>-----------------------[End 2/1]
		...
		[CommandProperty( AccessLevel.Administrator )]
		public int GodKills	{ get { return m_GodKills; } set { m_GodKills = value; } }
		//--<<Hunting>>---------------------------[End 1/1]
		
		//--<<Custom BODs>>-----------------------[Start 1/1]
		public bool GetMyFlag( MyPlayerFlag flag ) { return ( ( m_Flags & flag ) != 0 ); }
		...
		//--<< Event System >>--------------------[Start 2/2]		
		[CommandProperty( AccessLevel.Administrator )]
		public TeamType TeamType { get { return m_Team; } set { m_Team = value; } }			
		...
		public override void Serialize( GenericWriter writer )
		{
			...
			//writer.Write( m_GameLevel );
			//writer.Write( m_Banned );
