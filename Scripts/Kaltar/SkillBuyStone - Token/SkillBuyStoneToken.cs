...
namespace Server.Items
{
	public class SkillBuyStone : Item
	{
		...
		private int m_PriceInToken = 50000;
		...
		[CommandProperty( AccessLevel.Seer )]
		public int PriceInToken{get{return m_PriceInToken;}set{m_PriceInToken = value;InvalidateProperties();}}
		//End Prices
