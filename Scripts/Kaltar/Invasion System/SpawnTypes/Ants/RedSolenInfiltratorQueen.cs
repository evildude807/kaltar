...
namespace Scripts.Invasion_System
{
    ...
    public class InvasionRedSolenInfiltratorQueen : InvasionSpawn
	{
		[Constructable]
        public InvasionRedSolenInfiltratorQueen(InvasionController c)
		...
		public InvasionRedSolenInfiltratorQueen( Serial serial ) : base( serial )
		{
		}
