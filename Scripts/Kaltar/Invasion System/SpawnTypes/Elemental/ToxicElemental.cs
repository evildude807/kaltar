...
namespace Scripts.Invasion_System
{
    ...
    public class InvasionToxicElemental : InvasionSpawn
	{
		[Constructable]
        public InvasionToxicElemental(InvasionController c)
		...
		public InvasionToxicElemental( Serial serial ) : base( serial )
		{
		}
