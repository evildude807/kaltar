...
namespace Scripts.Invasion_System
{
    ...
    public class InvasionExodusOverseer : InvasionSpawn
	{
		...
		[Constructable]
        public InvasionExodusOverseer(InvasionController c)
            : base(c, InvasionSpawnType.Exodus, AIType.AI_Melee, FightMode.Closest, new double[] { 10, 1, 0.2, 0.4 })
		{
		...
		public InvasionExodusOverseer( Serial serial ) : base( serial )
		{
		}
