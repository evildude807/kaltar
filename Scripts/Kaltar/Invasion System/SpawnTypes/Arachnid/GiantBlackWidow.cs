...
namespace Scripts.Invasion_System
{
    ...
    public class InvasionGiantBlackWidow : InvasionSpawn
	{
		[Constructable]
        public InvasionGiantBlackWidow(InvasionController c)
		...
		public InvasionGiantBlackWidow( Serial serial ) : base( serial )
		{
		}
